...
def ID_array():
    ...
    frametime = array([3.2, 3.2, 0.8, 3.2, 3.2, 1.5, 3.1, 3.2, 3.1, 3.2, 0.4,
                       0.4, 0.4, 0.4, 0.4, 0.4, 3.2, 0.8, 1.1, 3.2, 0.4, 0.4,
                       0.8, 0.4])
    ret = vstack((ID, RA, DEC, z, name, dist, area_ext, frametime))
    return ret


# Creates the list of double sources
def double_list():
    double = ['01590', '04913', '12713', '12863']
    return double


# Creates the list of piledup sources
def piledup():
    piled = ['04054', '12242', '12291', '12863', '12864', '12866', '12867',
